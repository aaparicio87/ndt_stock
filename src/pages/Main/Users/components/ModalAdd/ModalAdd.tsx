...
const _optionsRoles = ROLES.map((label) => ({
  label,
  ...
  return (
    ...
    >
      ...
      <form onSubmit={onSubmitUser}>
        <ModalContent>
          <ModalHeader>
            {staffElement ? "Edit user" : "Create user"}
          </ModalHeader>
          <ModalCloseButton />
          {!loading ? (
            <>
                ...
                <HStack spacing={4} py={3}>
                  ...
                  >
                    ...
                    <MultiSelect
                      ...
                      menuPlacement="auto"
                      handleFocus={() =>
                        errors.certificates && clearErrors("certificates")
                      }
                    />
                    <FormErrorMessage>
                ...
                <HStack spacing={4} py={3}>
                  ...
                  >
                    ...
                    <MultiSelect
                      ...
                      menuPlacement="auto"
                      handleFocus={() => errors.roles && clearErrors("roles")}
                    />
                    <FormErrorMessage>
