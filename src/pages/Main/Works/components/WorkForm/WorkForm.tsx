        ...
        <form onSubmit={handleCreateUpdateWork}>
          <HStack py={3}>
            <FormControl isInvalid={!!errors.typeWork}>
              ...
              <MultiSelect
                ...
                handleFocus={() => errors.typeWork && clearErrors("typeWork")}
              />
              <FormErrorMessage>
          ...
          <HStack py={3}>
            <FormControl isInvalid={!!errors.workers}>
              ...
              <MultiSelect
                ...
                handleFocus={() => errors.workers && clearErrors("workers")}
              />
              <FormErrorMessage>
          ...
          <HStack spacing={4}>
            <FormControl isInvalid={!!errors.customer}>
              ...
              <Select
                ...
                onClick={() => errors.customer && clearErrors("customer")}
              >
          ...
          <HStack spacing={4} py={3}>
            <FormControl>
              ...
              <Input placeholder="Enter the address" {...register("address")} />
              <FormErrorMessage>
          ...
          <HStack spacing={4} py={3}>
            ...
            <FormControl>
              <FormLabel>Need to deliver?</FormLabel>
              <Switch
                colorScheme="teal"
                size="lg"
                alignSelf={"center"}
